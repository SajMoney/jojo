        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GalleryBackgroundColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPublic = table.Column<bool>(type: "bit", nullable: false),
                    ExifDateTaken = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Thumbnail", x => new { x.FileId, x.Type });
                    table.ForeignKey(
                        name: "FK_Thumbnail_Files_FileId",
                        column: x => x.FileId,
